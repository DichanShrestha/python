...
def initialize_data():
    """Initialize default menu and empty orders list."""
    global menu, orders
...
def take_order():
    ...
    if order_items:
        ...
        order_id = max([order.get('order_id', 0) for order in orders], default=0) + 1
...
def manager():
    ...
    while True:
        ...
        if choice == "1":
            ...
            print("Note: All data will be lost when the program exits.")
            break
        else:
